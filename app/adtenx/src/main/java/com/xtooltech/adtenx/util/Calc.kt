...
// raw =(data[2].b2i() &0x80)?0:1
fun calcu1(data:List<Byte>):String{
    return if  (data[2].b2i()  and 0x80 ==0x01 ) "MIL ON" else "MIL OFF"
}
// index= 0x00,0x00,0x01,0x20
// raw =(data[3].b2i() &0x01)?0:1
fun calcu2(data:List<Byte>):String{
    return if  (data[3].b2i()  and 0x01 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x21
// raw =(data[3].b2i() &0x02)?0:1
fun calcu3(data:List<Byte>):String{
    return if  (data[3].b2i()  and 0x02 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x22
// raw =(data[3].b2i() &0x04)?0:1
fun calcu4(data:List<Byte>):String{
    return if  (data[3].b2i()  and 0x04 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x24
// raw =(data[3].b2i() &0x10)?0:1
fun calcu5(data:List<Byte>):String{
    return if  (data[3].b2i()  and 0x10 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x25
// raw =(data[3].b2i() &0x20)?0:1
fun calcu6(data:List<Byte>):String{
    return if  (data[3].b2i()  and 0x20 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x26
// raw =(data[3].b2i() &0x40)?0:1
fun calcu7(data:List<Byte>):String{
    return if  (data[3].b2i()  and 0x40 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x30
// raw =(data[4].b2i() &0x01)?0:1
fun calcu8(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x01 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x31
// raw =(data[4].b2i() &0x02)?0:1
fun calcu9(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x02 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x32
// raw =(data[4].b2i() &0x04)?0:1
fun calcu10(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x04 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x33
// raw =(data[4].b2i() &0x08)?0:1
fun calcu11(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x08 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x34
// raw =(data[4].b2i() &0x10)?0:1
fun calcu12(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x10 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x35
// raw =(data[4].b2i() &0x20)?0:1
fun calcu13(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x20 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x36
// raw =(data[4].b2i() &0x40)?0:1
fun calcu14(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x40 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x37
// raw =(data[4].b2i() &0x80)?0:1
fun calcu15(data:List<Byte>):String{
    return if  (data[4].b2i()  and 0x80 ==0x01 ) "YES" else "NO"
}
// index= 0x00,0x00,0x01,0x40
// raw =(data[5].b2i() &0x01)?0:1
fun calcu16(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x01 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x41
// raw =(data[5].b2i() &0x02)?0:1
fun calcu17(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x02 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x42
// raw =(data[5].b2i() &0x04)?0:1
fun calcu18(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x04 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x43
// raw =(data[5].b2i() &0x08)?0:1
fun calcu19(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x08 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x44
// raw =(data[5].b2i() &0x10)?0:1
fun calcu20(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x10 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x45
// raw =(data[5].b2i() &0x20)?0:1
fun calcu21(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x20 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x46
// raw =(data[5].b2i() &0x40)?0:1
fun calcu22(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x40 ==0x01 ) "NO" else "YES"
}
// index= 0x00,0x00,0x01,0x47
// raw =(data[5].b2i() &0x80)?0:1
fun calcu23(data:List<Byte>):String{
    return if  (data[5].b2i()  and 0x80 ==0x01 ) "NO" else "YES"
}
...
fun calcu24(data: List<Byte>): String {
    ...
    buffer.append(String.format("%02X", data[3]))
    buffer.append(String.format("%02X", data[4]))
...
fun calcu27(data:List<Byte>):String{
    return  String.format("%3.1f", data[2].b2i() *100.0/255)
}
// index= 0x00,0x00,0x05,0x00
// raw =data[2].b2i() -40
fun calcu28(data:List<Byte>):String{
    return  String.format("%d", data[2].b2i() -40)
}
// index= 0x00,0x00,0x06,0x00
// raw =data[2].b2i() *199.2/255-100
fun calcu29(data:List<Byte>):String{
    return  String.format("%3.1f", data[2].b2i() *199.2/255-100)
}
...
fun calcu37(data:List<Byte>):String{
    return  String.format("%d", data[2].b2i() *3)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )/4
fun calcu39(data:List<Byte>):String{
    return  String.format("%d", (data[2].b2i() *256+data[3].b2i() )/4)
}
...
// raw =data[2].b2i() /2.0-64
fun calcu41(data:List<Byte>):String{
    return  String.format("%2.1f", data[2].b2i() /2.0-64)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )/100.0
fun calcu43(data:List<Byte>):String{
    return  String.format("%3.2f", (data[2].b2i() *256+data[3].b2i() )/100.0)
}
...
// raw =data[2].b2i() *0.005
fun calcu47(data:List<Byte>):String{
    return  String.format("%1.3f", data[2].b2i() *0.005)
}
...
// raw =data[3].b2i() *199.2/255-100
fun calcu49(data:List<Byte>):String{
    return  String.format("%3.1f", data[3].b2i() *199.2/255-100)
}
...
// raw =data[2].b2i() *256+data[3].b2i()
fun calcu82(data:List<Byte>):String{
    return  String.format("%d", data[2].b2i() *256+data[3].b2i() )
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.079
fun calcu84(data:List<Byte>):String{
    return  String.format("%4.3f", (data[2].b2i() *256+data[3].b2i() )*0.079)
}
// index= 0x00,0x00,0x23,0x00
// raw =(data[2].b2i() *256+data[3].b2i() )*10
fun calcu85(data:List<Byte>):String{
    return  String.format("%d", (data[2].b2i() *256+data[3].b2i() )*10)
}
// index= 0x00,0x00,0x24,0x00
// raw =(data[2].b2i() *256+data[3].b2i() )*2.0/65536
fun calcu86(data:List<Byte>):String{
    return  String.format("%1.3f", (data[2].b2i() *256+data[3].b2i() )*2.0/65536)
}
...
// raw =(data[4].b2i() *256+data[5].b2i() )*8.0/65536
fun calcu88(data:List<Byte>):String{
    return  String.format("%1.3f", (data[4].b2i() *256+data[5].b2i() )*8.0/65536)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.25
fun calcu124(data:List<Byte>):String{
    return  String.format("%4.2f", (data[2].b2i() *256+data[3].b2i() )*0.25)
}
...
// raw =(data[3].b2i() *256+data[4].b2i() )*128.0/65536-128
fun calcu128(data:List<Byte>):String{
    return  String.format("%3.3f", (data[3].b2i() *256+data[4].b2i() )*128.0/65536-128)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.1-40
fun calcu158(data:List<Byte>):String{
    return  String.format("%4.1f", (data[2].b2i() *256+data[3].b2i() )*0.1-40)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.001
fun calcu184(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )*0.001)
}
// index= 0x00,0x00,0x43,0x00
// raw =(data[2].b2i() *256+data[3].b2i() )*100/255.0
fun calcu185(data:List<Byte>):String{
    return  String.format("%3.1f", (data[2].b2i() *256+data[3].b2i() )*100/255.0)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )/10.0
fun calcu198(data:List<Byte>):String{
    return  String.format("%4.1f", (data[2].b2i() *256+data[3].b2i() )/10.0)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )/1000.0
fun calcu200(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )/1000.0)
}
// index= 0x00,0x06,0x12,0x05
// raw =(data[2].b2i() *256+data[3].b2i() )*256.0/65536
fun calcu201(data:List<Byte>):String{
    return  String.format("%1.3f", (data[2].b2i() *256+data[3].b2i() )*256.0/65536)
}
// index= 0x00,0x06,0x12,0x06
// raw =(data[2].b2i() *256+data[3].b2i() )*20.0/65536
fun calcu202(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )*20.0/65536)
}
// index= 0x00,0x06,0x12,0x07
// raw =(data[2].b2i() *256+data[3].b2i() )*0.25+0.5
fun calcu203(data:List<Byte>):String{
    return  String.format("%5.0f", (data[2].b2i() *256+data[3].b2i() )*0.25+0.5)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*8.0/65536
fun calcu206(data:List<Byte>):String{
    return  String.format("%1.4f", (data[2].b2i() *256+data[3].b2i() )*8.0/65536)
}
...
fun calcu208(data:List<Byte>):String{
    return  String.format("%3.3f", (data[2].b2i() *256+data[3].b2i() )/100.0)
}
// index= 0x00,0x06,0x12,0x0D
// raw =(data[2].b2i() *256+data[3].b2i() )*256.0/65536
fun calcu209(data:List<Byte>):String{
    return  String.format("%3.3f", (data[2].b2i() *256+data[3].b2i() )*256.0/65536)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() -40)/10.0
fun calcu218(data:List<Byte>):String{
    return  String.format("%4.1f", (data[2].b2i() *256+data[3].b2i() -40)/10.0)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.0117
fun calcu220(data:List<Byte>):String{
    return  String.format("%3.3f", (data[2].b2i() *256+data[3].b2i() )*0.0117)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.5
fun calcu225(data:List<Byte>):String{
    return  String.format("%5.1f", (data[2].b2i() *256+data[3].b2i() )*0.5)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.05
fun calcu227(data:List<Byte>):String{
    return  String.format("%4.2f", (data[2].b2i() *256+data[3].b2i() )*0.05)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )/1000
fun calcu229(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )/1000)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )/10000
fun calcu234(data:List<Byte>):String{
    return  String.format("%2.4f", (data[2].b2i() *256+data[3].b2i() )/10000)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )16.384/65535
fun calcu237(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )*16.384/65535)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )?1:0
fun calcu242(data:List<Byte>):String{
    return if  (data[2].b2i() *256+data[3].b2i()  ==0x01 ) "false" else "true"
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*100.0/65535
fun calcu244(data:List<Byte>):String{
    return  String.format("%3.2f", (data[2].b2i() *256+data[3].b2i() )*100.0/65535)
}
...
fun calcu246(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )*2.0/65536)
}
// index= 0x00,0x06,0x12,0x33
// raw =(data[2].b2i() *256+data[3].b2i() )*16.0/65535
fun calcu247(data:List<Byte>):String{
    return  String.format("%2.2f", (data[2].b2i() *256+data[3].b2i() )*16.0/65535)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.1
fun calcu326(data:List<Byte>):String{
    return  String.format("%4.1f", (data[2].b2i() *256+data[3].b2i() )*0.1)
}
// index= 0x00,0x06,0x12,0x83
// raw =(data[2].b2i() *256+data[3].b2i() )*0.01
fun calcu327(data:List<Byte>):String{
    return  String.format("%3.2f", (data[2].b2i() *256+data[3].b2i() )*0.01)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*0.999/32768
fun calcu329(data:List<Byte>):String{
    return  String.format("%1.3f", (data[2].b2i() *256+data[3].b2i() )*0.999/32768)
}
// index= 0x00,0x06,0x12,0x86
// raw =(data[2].b2i() *256+data[3].b2i() )*9.99424/32768
fun calcu330(data:List<Byte>):String{
    return  String.format("%2.3f", (data[2].b2i() *256+data[3].b2i() )*9.99424/32768)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*3.997696/32768
fun calcu334(data:List<Byte>):String{
    return  String.format("%1.4f", (data[2].b2i() *256+data[3].b2i() )*3.997696/32768)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*128.0/32768
fun calcu337(data:List<Byte>):String{
    return  String.format("%3.3f", (data[2].b2i() *256+data[3].b2i() )*128.0/32768)
}
...
// raw =(data[2].b2i() *256+data[3].b2i() )*100.007936/32768
fun calcu372(data:List<Byte>):String{
    return  String.format("%3.2f", (data[2].b2i() *256+data[3].b2i() )*100.007936/32768)
}
...
fun calcu449(data:List<Byte>):String{
    return  String.format("%3.2f", (data[2].b2i() *256+data[3].b2i() )*0.001)
}
