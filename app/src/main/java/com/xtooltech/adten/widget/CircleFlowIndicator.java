...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int inactiveDefaultColor = Color.GRAY;
		...
		// Retrieve the radius
		mRadius = a.getDimension(R.styleable.CircleFlowIndicator_radius1, 4.0f);
		...
		mSnap = a.getBoolean(R.styleable.CircleFlowIndicator_snap1, false);
